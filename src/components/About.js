      ...
      <div className="accordion" id="accordionExample">
        <div className="accordion-item">
          ...
          >
            ...
            TextUtils gives you a way to analyze your text quickly and efficiently. Be it word count, character count or approximate reading time.
            </div>
          </div>
        </div>
        <div className="accordion-item">
        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body" style={myStyle}>
              ...
              It suits to count characters in facebook, blog, books, excel, pdf document, essays, etc.
            </div>
          </div>
        </div>
      </div>
